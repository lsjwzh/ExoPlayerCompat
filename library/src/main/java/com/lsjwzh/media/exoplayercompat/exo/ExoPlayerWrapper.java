...
//  public static final int TYPE_DEBUG = 3;
 ...
 private TrackRenderer[] mTrackRenderers;
...
//    selectedTracks[TYPE_TEXT] = DISABLED_TRACK;
  ...
  public void prepare() {
    ...
    public void setVolume(float volume){
        try {
            ((MediaCodecAudioTrackRenderer)mTrackRenderers[TYPE_AUDIO]).handleMessage(MediaCodecAudioTrackRenderer.MSG_SET_VOLUME,volume);
