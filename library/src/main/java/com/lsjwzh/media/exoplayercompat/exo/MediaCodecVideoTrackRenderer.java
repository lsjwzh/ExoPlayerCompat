...
/**
 * Decodes and renders video using {@link android.media.MediaCodec}.
 */
@TargetApi(16)
public class MediaCodecVideoTrackRenderer extends MediaCodecTrackRenderer {
   ...
   * should be the target {@link android.view.Surface}, or null.
   */
   ...
   *     {@link android.media.MediaCodec#setVideoScalingMode(int)}.
   */
