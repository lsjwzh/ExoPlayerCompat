...
/**
 * An abstract {@link com.google.android.exoplayer.TrackRenderer} that uses {@link android.media.MediaCodec} to decode samples for rendering.
 */
@TargetApi(16)
public abstract class MediaCodecTrackRenderer extends TrackRenderer {

  /**
   * Interface definition for a callback to be notified of {@link com.lsjwzh.media.exoplayercompat.exo.MediaCodecTrackRenderer} events.
   */
  ...
  /**
   * If the {@link android.media.MediaCodec} is hotswapped (i.e. replaced during playback), this is the period of
  ...
  /**
   * Configures a newly created {@link android.media.MediaCodec}. Sub-classes should
...
//        }
   ...
   * @throws com.google.android.exoplayer.ExoPlaybackException If an error occurs feeding the input buffer.
   */
  ...
  /**
   * Invoked when a new format is read from the upstream {@link com.google.android.exoplayer.SampleSource}.
   *
   * @param formatHolder Holds the new format.
   * @throws com.google.android.exoplayer.ExoPlaybackException If an error occurs reinitializing the {@link android.media.MediaCodec}.
   */
  ...
  /**
   * Invoked when the output format of the {@link android.media.MediaCodec} changes.
   * <p>
  ...
  /**
   * Determines whether the existing {@link android.media.MediaCodec} should be reconfigured for a new format by
   * sending codec specific initialization data at the start of the next input buffer. If true is
   * returned then the {@link android.media.MediaCodec} instance will be reconfigured in this way. If false is
   * returned then the instance will be released, and a new instance will be created for the new
   * format.
   * <p>
   * The default implementation returns false.
   *
   * @param codec The existing {@link android.media.MediaCodec} instance.
   ...
   * @throws com.google.android.exoplayer.ExoPlaybackException If an error occurs draining the output buffer.
   */
   ...
   * @throws com.google.android.exoplayer.ExoPlaybackException If an error occurs processing the output buffer.
   */
